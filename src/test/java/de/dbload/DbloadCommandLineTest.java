...
class DbloadCommandLineTest {
    ...
    void dbloadCommandLine() {
        ...
        final String[] args = { "-u", "betoffice", "-p", "betoffice",
                ...
                "--tables",
                "bo_session,bo_user,bo_team,bo_teamalias,bo_grouptype,bo_season,bo_group,bo_team_group,bo_player,bo_location,bo_gamelist,bo_game,bo_goal,bo_gametipp,bo_community,bo_community_user",
                "-f", "export.dat",
                "--export" };
