...
public class DefaultDbloadContext implements DbloadContext {
     ...
     */
    public DefaultDbloadContext(Connection _conn, JdbcTypeConverter _jdbcTypeConverter) {
        conn = _conn;
        jdbcTypeConverter = _jdbcTypeConverter;
    }

    /* (non-Javadoc)
     * @see de.dbload.impl.IDbloadContext#getConnection()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see de.dbload.impl.IDbloadContext#getJdbcTypeConverter()
     */
    @Override
